...
function pmodload {
  ...
  function {
    ...
    for pfunction in ${ZDOTDIR:-$HOME}/.zsh/modules/${^pmodules}/functions/$~pfunction_glob; do
  ...
  for pmodule in "$pmodules[@]"; do
    if zstyle -t ":prezto:module:$pmodule" loaded 'yes' 'no'; then
      ...
      if [[ -s "${ZDOTDIR:-$HOME}/.zsh/modules/$pmodule/init.zsh" ]]; then
        source "${ZDOTDIR:-$HOME}/.zsh/modules/$pmodule/init.zsh"
      fi
